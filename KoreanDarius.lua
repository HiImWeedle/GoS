...
local Rdmg =  ((basedmg + stacksdmg) + ((({0, 35 * KoreanDarius.KS.XX:Value(), 69 * KoreanDarius.KS.XX:Value(), 123 * KoreanDarius.KS.XX:Value()})[level]) * (({0, 0.2, 0.4, 0.6, 0.8, 1})[Stacks]))) --CalcPhysicalDamage(myHero, target, ((basedmg + stacksdmg)))
	return Rdmg
	end
end
