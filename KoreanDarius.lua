...
local Rdmg =  ((basedmg + stacksdmg) + ((({0, 30 * KoreanDarius.KS.XX:Value(), 90 * KoreanDarius.KS.XX:Value(), 120 * KoreanDarius.KS.XX:Value()})[level]) * (({0, 0.2, 0.4, 0.6, 0.8, 1})[Stacks]))) --CalcPhysicalDamage(myHero, target, ((basedmg + stacksdmg)))
	return Rdmg
	end
end
